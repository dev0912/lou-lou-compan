...
Filter.prototype.beforeInit=function(){this.isBadUrl()&&(this.isInit=!0,window.location.href=window.location.pathname)},Filter.prototype.isBadUrl=function(){try{var t=decodeURIComponent(window.location.search).split("&"),n=!1;if(t.length>0)for(var e=0;e<t.length;e++){var o=t[e],a=(o.match(/</g)||[]).length,i=(o.match(/>/g)||[]).length,r=(o.match(/alert\(/g)||[]).length,h=(o.match(/on[A-Za-z]+=/g)||[]).length,l=(o.match(/execCommand/g)||[]).length;if(a>0&&i>0||a>1||i>1||r||h||l){n=!0;break}}return n}catch(t){return!0}};
